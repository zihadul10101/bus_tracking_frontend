...
//     const res = await api.post<ApiResponse<SubAdmin>>(
...
//   // Get All
//   getAll: async () => {
//     const res = await api.get<ApiResponse<SubAdmin[]>>(
//       "/admin/sub-admins"
//     );
//     return res.data;
//   },
...
//   update: async (
//     id: string,
//     data: Partial<CreateSubAdminDto>
//   ) => {
//     const res = await api.put<ApiResponse<SubAdmin>>(
//       `/admin/sub-admin/${id}`,
//       data
//     );
//     return res.data;
